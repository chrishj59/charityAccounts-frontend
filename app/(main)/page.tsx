      ...
      {/* <div className="flex min-h-screen " style={{ minHeight: '300px' }}> */}
         <Panel  >
          <div className='flex justify-content-center text-primary'>
            <div className="text-2xl text-primary-400"> Rationes Charitatis Features</div>
          </div>
          <div className='grid'>
              ...
              <div className="card">
                <Card title="Payables and expenses">
                  ...
                  {/* <ul className="list-disc">
                    ...
                    <li>Report on supplier balances and transactions. Including aged reports</li>
              ...
              <div className="card">
                <Card title="Receivables">
                  ...
                  {/* <ul className="list-disc">
                    ...
                    <li>Report on customer balances and transactions. Including aged reports</li>
                  </ul> */}
                </Card>
              </div>
            </div>
            <div className='col-12 md:col-6'>
              <div className="card">
                <Card title="Manage Funds">
                  Manage Grant and restricted funds
                  {/* <ul className="list-disc">
                    <li>Manage fund master record</li>
                    <li>Income & Expenditure and balance by fund reporting</li>
                    <li>Generate fund performance reports</li>
                  </ul> */}
                </Card>
              </div>
            ...
            <div className='col-12 md:col-6'>
              <div className="card">
                <Card title="VAT - MTD">
                  ...
                  {/* <ul className="list-disc">
                    <li>Submit VAT reports online</li>
                    <li>VAT only transactions</li>
                    <li>VAT reports including documents included in return</li>
                  </ul> */}
                </Card>
              </div>  
            </div>
            <div className='col-12 md:col-6'>
              <div className="card">
                <Card title="Multi-organsiation">
                  Support for multiple organisation
                  {/* <ul className="list-disc">
                    <li>Supports Sole trader, partnership, and limited company</li>
                    <li>The  basic tier supports a single organistion</li>
                    <li>Premium tiers support a higher number of organisations</li>
                  </ul> */}
            ...
            <div className='col-12 md:col-6'>
              <div className="card">
                <Card  title="Security ">
                 <p className="text-primary"> User credentials held by authentication provider </p>
                  {/* <ul className="list-disc">
                    <li>Follows best practice</li>
                    <li>Credentials are not held on this site</li>
                    <li>Role based authorisation so users have access to the features they need</li>
                  </ul> */}
                </Card>
              </div>  
            </div>
