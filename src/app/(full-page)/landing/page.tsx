...
const LandingPage: Page = () => {
  ...
  useEffect(() => {
    setDarkMode(
      layoutConfig.colorScheme === 'dark' || layoutConfig.colorScheme === 'dim'
        ? true
        : false,
    );
      ...
      <div className='landing-wrapper'>
        ...
        <div className='py-4 px-4 mx-0 md:mx-6 lg:mx-8 lg:px-8 z-2'>
          ...
          <div id='apps' className='my-6 md:my-8'>
            ...
            <div className='flex flex-column lg:flex-row align-items-center justify-content-between mt-8 gap-8'>
              ...
              <div className='flex flex-column align-items-center'>
                <img
                  src={`/demo/images/landing/${
                    darkMode ? 'kanban-dark' : 'kanban-light'
                  }.png`}
                  alt='chat'
                  className='w-full h-full border-round surface-border shadow-2 animation-duration-500 scalein origin-top'
                />
          ...
          <div id='features' className='my-6 py-6 md:my-8 md:py-8'>
            ...
            <span className='text-700 block text-xl mb-8 text-center line-height-3'>
              PrimeTek Informatics is the author of PrimeReact, a UI Component
              vendor with well known vastly popular projects including
              PrimeFaces, PrimeNG and PrimeVue.
            </span>
            ...
            <div className='grid mt-8'>
              <div className='col-12 md:col-6 xl:col-3 flex justify-content-center p-3'>
                <div className='box p-4 w-full surface-card surface-border border-1 border-round'>
                  ...
                  <p className='m-0 text-secondary text-700'>
                    The ultimate set of UI Components to assist you with 90+
              ...
              <div className='col-12 md:col-6 xl:col-3 flex justify-content-center p-3'>
                <div className='box p-4 w-full surface-card surface-border border-1 border-round'>
                  ...
                  <p className='m-0 text-secondary text-700'>
                    Connect with the other open source community members,
                    collaborate and have a voice in the project roadmap.
                  </p>
                </div>
              </div>
              <div className='col-12 md:col-6 xl:col-3 flex justify-content-center p-3'>
                <div className='box p-4 w-full surface-card surface-border border-1 border-round'>
                  ...
                  <p className='m-0 text-secondary text-700'>
                    Boost your productivity by achieving more in less time and
              ...
              <div className='col-12 md:col-6 xl:col-3 flex justify-content-center p-3'>
                <div className='box p-4 w-full surface-card surface-border border-1 border-round'>
                  ...
                  <p className='m-0 text-secondary text-700'>
                    Exceptional support service featuring response within 1
                    business day and option to request enhancements and new
              ...
              <div className='col-12 md:col-6 xl:col-3 flex justify-content-center p-3'>
                <div className='box p-4 w-full surface-card surface-border border-1 border-round'>
                  ...
                  <p className='m-0 text-secondary text-700'>
                    First class support for responsive design led by touch
                    optimized elements.
                  </p>
                </div>
              </div>
              <div className='col-12 md:col-6 xl:col-3 flex justify-content-center p-3'>
                <div className='box p-4 w-full surface-card surface-border border-1 border-round'>
                  ...
                  <p className='m-0 text-secondary text-700'>
                    Built on a design-agnostic api, choose from a vast amount of
                    themes such as material, bootstrap, custom or develop your
                    own.
                  </p>
                </div>
              </div>
              <div className='col-12 md:col-6 xl:col-3 flex justify-content-center p-3'>
                <div className='box p-4 w-full surface-card surface-border border-1 border-round'>
                  ...
                  <p className='m-0 text-secondary text-700'>
                    Top-notch support for Typescript with types and tooling
                    assistance.
                  </p>
                </div>
              </div>
